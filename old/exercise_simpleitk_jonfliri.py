...
def register_images(img, label_img, atlas_img):
    ...
    registered_img = sitk.Resample(img, atlas_img, transform, sitk.sitkLinear, 0., img.GetPixelIDValue())  # todo: modify here
    ...
    registered_label = sitk.Resample(label_img, atlas_img, transform, sitk.sitkNearestNeighbor, 0., label_img.GetPixelIDValue())  # todo: modify here
